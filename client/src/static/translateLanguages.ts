...
/**
 * Full language list supported by Google Translate.
 * English (value: "") is the default/restore option.
 */
export const ALL_LANGUAGES: Lang[] = [
  { value: "", label: "English" },
  ...
  { value: "tzm-Tfng", label: "Tamazight (Tifinagh)" },
